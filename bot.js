...
console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~');
console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~');
console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~Team #Flex Bot ~~~~~~~~~~~');
console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~');
console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~');
console.log(`Logged in as  * [ "  Team #Flex bot " ] servers! [ " ${client.guilds.size} " ] Users! [ " ${client.users.size} " ]`); 
...
client.on('ready', function(){
    ...
    var ms = 100000 ;
    var setGame = [`help Servers ${$help - $invite} `,`invite Users ${client.users.size}`];
    var i = -1;
    var j = 0;
    setInterval(function (){
        ...
        i = i+j;
        client.user.setGame(setGame[i],`https://www.youtube.com/channel/UCIO0mWCFc26LCrjwJU_S4mA`);
    }, ms);100000
...
client.on('message', message => {
    ...
    if (message.content === "Flex bot") {
        ...
        message.edit('**Flex**')
        message.edit('**Felx b**')
        message.edit('**Flex bo**')
        message.edit('**Flex bot*')
        }, 1000)
    }
        ...
        if (message.content.toUpperCase() === prefix + `DAILY`) {
                ...
                if (money[message.author.username + message.guild.name] != moment().format('L')) {
                    ...
                    money.updateBal(message.author.id, 500 ,200).then((i) => { // The daily ends of the day, so everyday they can get a daily bonus, if they missed it, they can't get it back again.
                        message.channel.send({embed: {
                            color: 3447003,
                            description: 'Recieved your **$764** \`^daily`\. I think you should check \`^credits\`.',
                            author: {
...
client.login(NjEzNDA5MzkwMDQ4OTY4ODgw.XV1jeg.PaE_vmjwU6bkBkbTgl7x7nycgmY);
